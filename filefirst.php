...
<div class="container-fluid" style="margin-left:0px; margin-right: 0px; padding-left: 0px; padding-right: 0px;">
  ...
  <div class="row">
    ...
    <div class="col-lg-9">
      <div class="panel blue" style="padding-top:60px;padding-right:30px;">
          <button>Previous  works </button>
          <button onclick="window.location.href='file.php'">Application & Notices</button>
          <button>Necessary files</button>
